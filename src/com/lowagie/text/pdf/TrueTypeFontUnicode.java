/*
 * $Id: TrueTypeFontUnicode.java 2864 2007-07-03 15:13:38Z psoares33 $
 * $Name$
 *
...
class TrueTypeFontUnicode extends TrueTypeFont implements Comparator{
    ...
    public boolean charExists(char c) {
        ...
        if (fontSpecific) {
            if ((c & 0xff00) == 0 || (c & 0xff00) == 0xf000)
                return map.get(Integer.valueOf(c & 0xff)) != null;
            else
                return false;
        }
        else
            return map.get(Integer.valueOf(c)) != null;
    }
    ...
    public boolean setCharAdvance(char c, int advance) {
        ...
        if (fontSpecific) {
            if ((c & 0xff00) == 0 || (c & 0xff00) == 0xf000)
                m = (int[])map.get(Integer.valueOf(c & 0xff));
            else
                return false;
        }
        else
            m = (int[])map.get(Integer.valueOf(c));
        if (m == null)
            return false;
        else
            m[1] = advance;
